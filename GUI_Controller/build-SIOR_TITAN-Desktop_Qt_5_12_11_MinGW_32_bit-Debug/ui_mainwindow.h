...
public:
    ...
    QSpinBox *newSamIdSpinBox;
    QPushButton *setIdButton;
    QSpinBox *oldSamIdSpinBox;
    QLabel *oldSamId_label;
    QLabel *newSamId_label;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        humanoid_pic->setGeometry(QRect(690, 10, 291, 341));
        ...
        testWriteButton = new QPushButton(centralwidget);
        testWriteButton->setObjectName(QString::fromUtf8("testWriteButton"));
        testWriteButton->setGeometry(QRect(918, 450, 61, 25));
        ...
        testReadButton = new QPushButton(centralwidget);
        testReadButton->setObjectName(QString::fromUtf8("testReadButton"));
        testReadButton->setGeometry(QRect(920, 420, 61, 25));
        newSamIdSpinBox = new QSpinBox(centralwidget);
        newSamIdSpinBox->setObjectName(QString::fromUtf8("newSamIdSpinBox"));
        newSamIdSpinBox->setGeometry(QRect(810, 380, 101, 26));
        newSamIdSpinBox->setMinimum(0);
        newSamIdSpinBox->setMaximum(256);
        newSamIdSpinBox->setSingleStep(1);
        newSamIdSpinBox->setValue(0);
        setIdButton = new QPushButton(centralwidget);
        setIdButton->setObjectName(QString::fromUtf8("setIdButton"));
        setIdButton->setGeometry(QRect(920, 380, 61, 25));
        oldSamIdSpinBox = new QSpinBox(centralwidget);
        oldSamIdSpinBox->setObjectName(QString::fromUtf8("oldSamIdSpinBox"));
        oldSamIdSpinBox->setGeometry(QRect(690, 380, 101, 26));
        oldSamIdSpinBox->setMinimum(0);
        oldSamIdSpinBox->setMaximum(256);
        oldSamIdSpinBox->setSingleStep(1);
        oldSamIdSpinBox->setValue(0);
        oldSamId_label = new QLabel(centralwidget);
        oldSamId_label->setObjectName(QString::fromUtf8("oldSamId_label"));
        oldSamId_label->setGeometry(QRect(690, 360, 81, 16));
        oldSamId_label->setFont(font1);
        newSamId_label = new QLabel(centralwidget);
        newSamId_label->setObjectName(QString::fromUtf8("newSamId_label"));
        newSamId_label->setGeometry(QRect(810, 360, 81, 16));
        newSamId_label->setFont(font1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        testWriteButton->setText(QApplication::translate("MainWindow", "Write", nullptr));
...
"Group", nullptr));
        testReadButton->setText(QApplication::translate("MainWindow", "Read", nullptr));
        setIdButton->setText(QApplication::translate("MainWindow", "Set Id", nullptr));
        oldSamId_label->setText(QApplication::translate("MainWindow", "Old SamId", nullptr));
        newSamId_label->setText(QApplication::translate("MainWindow", "New SamId", nullptr));
